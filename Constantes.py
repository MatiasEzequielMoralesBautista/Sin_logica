...
CLICK_SONIDO = pygame.mixer.Sound(r"VENTANAS\VENTANAS\click.mp3")
ACIERTO_SONIDO = pygame.mixer.Sound(r"VENTANAS\VENTANAS\click.mp3")
ERROR_SONIDO = pygame.mixer.Sound(r"VENTANAS\VENTANAS\error.mp3")
